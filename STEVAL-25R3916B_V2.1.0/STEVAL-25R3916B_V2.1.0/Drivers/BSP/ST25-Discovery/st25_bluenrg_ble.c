...
/** @defgroup ST25_BLUENRG_BLE ST25 BlueNRG BLE
 *  @{
 */
...
void print_csv_time(void){
  __attribute__ ((unused)) uint32_t ms = ms_counter;

#if defined(__arm) && (__arm == __arm__) /* ARM Compiler */
  PRINT_CSV("%02u:%02u:%02u.%03u", ms/(60*60*1000)%24, ms/(60*1000)%60, (ms/1000)%60, ms%1000);
#elif defined ( __GNUC__ ) && !defined (__arm) /* GNU Compiler */
  PRINT_CSV("%02lu:%02lu:%02lu.%03lu", ms/(60*60*1000)%24, ms/(60*1000)%60, (ms/1000)%60, ms%1000);
#endif /* __GNUC__ */
}
