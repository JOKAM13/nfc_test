...
uint32_t FLASH_If_PageErase( const uint32_t Address, const uint32_t LastAddress )
{
  ...
  FLASH_EraseInitStruct.NbPages = ((LastAddress - Address) / 2048) + 1;
...
/**
  ...
  * @retval 0 BFB2 successfully written to Flash memory.
  * @retval 1 Error occurred while BFB2 bit in Flash memory.
  */
