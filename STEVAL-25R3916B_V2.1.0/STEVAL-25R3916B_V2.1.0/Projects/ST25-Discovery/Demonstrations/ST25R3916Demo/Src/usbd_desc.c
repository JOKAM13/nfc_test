...
#define USBD_PID                      0x3724
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "STMicroelectronics"
#define USBD_PRODUCT_HS_STRING        "STEVAL-ST25R3916B"
#define USBD_PRODUCT_FS_STRING        "STEVAL-ST25R3916B" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "Custom HS HID Config" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "Custom HS HID Interface" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING  "Custom FS HID Config" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "Custom FS HID Interface" /* Add your Interface Full Speed string */
